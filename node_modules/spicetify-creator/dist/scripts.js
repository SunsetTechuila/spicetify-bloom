...
const build = async (watch, minify, outDirectory) => {
    ...
    if (isExtension) {
        (0, buildExtension_1.default)(settings, outDirectory, watch, esbuildOptions, minify);
    }
    else {
        (0, buildCustomApp_1.default)(settings, outDirectory, watch, esbuildOptions, minify);
    }
    if (watch) {
